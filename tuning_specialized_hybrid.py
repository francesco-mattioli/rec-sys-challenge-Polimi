...
URM_train_pow_padded, ICM_stacked_with_weighted_impressions_padded = dataReader.pad_with_zeros_given_ICMandURM(
    ICM_stacked_with_weighted_impressions, URM_train_pow)

URM_train_super_pow = dataReader.load_super_powerful_URM(
    URM_train_pow_padded, ICM_stacked_with_weighted_impressions_padded, 0.8)
...
recommender_class = SpecializedHybrid
...
hyperparameters_range_dictionary["alpha_P"] = Real(
    low=0, high=2, prior='uniform')
hyperparameters_range_dictionary["normalize_similarity_P"] = Categorical([
    False])
...
recommender_input_args = SearchInputRecommenderArgs(
    ...
    CONSTRUCTOR_POSITIONAL_ARGS=[URM_train_aug,ICM],
