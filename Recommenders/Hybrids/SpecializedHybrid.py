...
# Reference: https://github.com/Lodz97/RecSys-PoliMi-2020/blob/8a7a57fc5f83d60cf489418c772906ca91ecdfcd/Recommenders/Hybrids/ScoresHybridSpecialized.py#L9


class SpecializedHybrid(BaseItemSimilarityMatrixRecommender):
    """ ItemKNNScoresHybridRecommender
    Hybrid of two prediction scores R = R1*alpha + R2*(1-alpha)
    NB: Rec_1 is itemKNNCF, Rec_2 is userKNNCF
    """

    RECOMMENDER_NAME = "SpecializedHybrid"

    def __init__(self, URM_train, ICM_train):
        super(SpecializedHybrid, self).__init__(URM_train)
    ...
    def recommend(self, user_id_array, cutoff=None, remove_seen_flag=True, items_to_compute=None,
        ...
        res = super(SpecializedHybrid, self).recommend(user_id_array, cutoff=cutoff, remove_seen_flag=remove_seen_flag,
