...
from Recommenders.Custom.CustomBaseRecommender import CustomBaseRecommender
from Recommenders.DataIO import DataIO
import numpy as np



class CustomBaseSimilarityMatrixRecommender(CustomBaseRecommender):
    """
    ...
    def __init__(self, URM_train, verbose=True):
        super(CustomBaseSimilarityMatrixRecommender, self).__init__(URM_train, verbose = verbose)
...
class CustomBaseItemSimilarityMatrixRecommender(CustomBaseSimilarityMatrixRecommender):
...
class CustomBaseUserSimilarityMatrixRecommender(CustomBaseSimilarityMatrixRecommender):
